...
} from "./chunk-BBASEOMJ.js";
import {
  Col_default,
  PlaceholderButton_default,
  Placeholder_default
} from "./chunk-AEBBOBKN.js";
import {
  require_react_dom
...
var FormLabel = React62.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column) return (0, import_jsx_runtime54.jsx)(Col_default, {
    ref,
    as: "label",
    className: classes,
    htmlFor,
...
var Switch = React66.forwardRef((props, ref) => (0, import_jsx_runtime58.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var RTGTransition = React76.forwardRef((_ref, ref) => {
  let {
    component: Component2
  } = _ref, props = _objectWithoutPropertiesLoose9(_ref, _excluded8);
  const transitionProps = useRTGTransitionProps(props);
  return (0, import_jsx_runtime68.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime69.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime69.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime69.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
var Modal = (0, import_react62.forwardRef)((_ref, ref) => {
  let {
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime70.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime70.jsx)("div", Object.assign({}, dialogProps, {
  ...
  return (0, import_jsx_runtime70.jsx)(import_jsx_runtime70.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime70.jsxs)(import_jsx_runtime70.Fragment, {
...
var ModalBody = React79.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalContext = React80.createContext({
...
var AbstractModalHeader = React83.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  const context5 = (0, import_react63.useContext)(ModalContext_default);
...
var ModalHeader = React84.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var ModalTitle = React85.forwardRef(({
  className,
  bsPrefix,
...
var Modal2 = React86.forwardRef(({
  ...
  const renderBackdrop = (0, import_react64.useCallback)((backdropProps) => (0, import_jsx_runtime78.jsx)("div", {
    ...backdropProps,
...
var NavItem2 = React87.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var NavLink = React88.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
...
var Nav2 = React89.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
...
var NavbarBrand = React90.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React91.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "navbar-collapse");
  const context5 = (0, import_react66.useContext)(NavbarContext_default);
...
var OffcanvasBody = React93.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React94.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime86.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React94.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React95.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React96.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React97.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const renderBackdrop = (0, import_react70.useCallback)((backdropProps) => (0, import_jsx_runtime89.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React98.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context5 = (0, import_react71.useContext)(NavbarContext_default);
  const handleHide = useEventCallback(() => {
...
var NavbarText = React99.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React100.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
...
var NavDropdown = React101.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React102.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
...
var PopoverHeader = React103.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React104.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React106.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
...
var Tooltip = React107.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
...
var Overlay2 = React108.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  return (0, import_jsx_runtime103.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React108.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React109.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  ...
  return (0, import_jsx_runtime106.jsxs)(import_jsx_runtime105.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react77.cloneElement)(children, triggerProps), (0, import_jsx_runtime104.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React110.forwardRef(({
  active = false,
  disabled = false,
  className,
  style: style2,
...
function createButton(name, defaultValue, label = name) {
  const Button = React110.forwardRef(({
    children,
    ...props
...
var Pagination = React111.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime110.jsx)("div", {
    ...
    "aria-valuemin": min2,
    "aria-valuemax": max2,
    children: visuallyHidden ? (0, import_jsx_runtime110.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
}
var ProgressBar = React112.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
...
var Ratio = React113.forwardRef(({
  ...
  return (0, import_jsx_runtime111.jsx)("div", {
    ...
    children: React113.Children.only(children)
  });
});
...
var Row = React114.forwardRef(({
  ...
  return (0, import_jsx_runtime112.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames78.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var Spinner = React115.forwardRef(({
  ...
  return (0, import_jsx_runtime113.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames79.default)(className, bsSpinnerPrefix, size2 && `${bsSpinnerPrefix}-${size2}`, variant && `text-${variant}`)
  });
});
...
var Stack = React117.forwardRef(({
  ...
  return (0, import_jsx_runtime116.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames80.default)(className, bsPrefix, ...createUtilityClassName({
      gap
...
function useTabPanel(_ref) {
  ...
  const context5 = (0, import_react79.useContext)(TabContext_default);
...
var TabContent = React121.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React122.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
    ...
    children: (0, import_jsx_runtime121.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime121.jsx)(Transition2, {
        ...
        children: (0, import_jsx_runtime121.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames82.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime122.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime122.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime123.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime122.jsx)(Nav_default2, {
      id,
      ...controlledProps,
      role: "tablist",
      as: "ul",
    ...
    }), (0, import_jsx_runtime122.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime122.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React124.forwardRef((props, ref) => (0, import_jsx_runtime124.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React126.forwardRef(({
  ...
  const context5 = (0, import_react81.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
  ...
  return (0, import_jsx_runtime126.jsxs)("div", {
    ...
    children: [children, closeButton && (0, import_jsx_runtime125.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var Toast = React128.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime128.jsx)("div", {
    ...props,
    ref,
  ...
  return (0, import_jsx_runtime128.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition2 ? (0, import_jsx_runtime128.jsx)(Transition2, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToggleButton = React130.forwardRef(({
  ...
  return (0, import_jsx_runtime132.jsxs)(import_jsx_runtime131.Fragment, {
    children: [(0, import_jsx_runtime130.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime130.jsx)(Button_default2, {
      ...props,
      ref,
...
var ToggleButtonGroup = React131.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime133.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
